...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="sr-only">Panel de control — Museo Etnográfico Edgar Palomeque</h1>
      ...
      <div className="bg-gradient-to-r from-[#6B0F0F] to-[#9B1C1C] rounded-xl p-5 text-white shadow-md">
        ...
        <h2 className="text-xl font-bold">{sesion?.nombres} {sesion?.apellidos}</h2>
        <p className="text-sm text-white/80 mt-0.5">{sesion?.rol}</p>
      </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-xs font-bold text-gray-600 uppercase tracking-widest">Acceso rápido</h2>
        </div>
